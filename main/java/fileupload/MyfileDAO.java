...
public class MyfileDAO extends DBConnPool { // 1, 2, 5 단계 상속하여 활용
	// JDBC 1~5 단계
	...
	public int insertFile(MyfileDTO myfileDTO) {
		int result = 0 ;
			...
			try {
				...
				pstmt.setString(5, myfileDTO.getSfile()); //3 단계 완성
	...
	public List<MyfileDTO> myFileList(){
		...
		try {
			String qurey = "select * from myfile order by idx desc"; // 모든 데이터를 찾아옴(내림차순)
