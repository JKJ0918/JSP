<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>요청에 대한 처리를 담당</title></head>
<body>
	<!-- request는 클라이언트(고객)가 값을 요청할 때 처리되는 내장된 메모리 영역  -->
	<!-- 메서드는 2개가 있는데 get방식, post방식 이 있다. -->
	<!-- get방식은 url을 통해서 요청하는 방법 : 가볍다, 보안성이 좋지 않다. -->
	<!-- post방식은 body를 통해서 요청하는 방법 : 보안상 좋고, 대용량 처리 가능, 무겁다. -->
	
	<h1> 1.클라이언트와 서버의 환경정보 일기 </h1>
	...
	관심사항 : <!-- checkbox : 복수선택용 -->
		...
		<input type="checkbox" name="favo" value="enter" />연예 <br>
	...
	<hr>
	<h3> 3. HTTP 요청 헤더 정보 읽기 </h3> <!-- 요청자의 정보를 알고 싶을 때 -->
